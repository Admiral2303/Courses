    ...
    <div class="col-md-6">
      <form v-on:submit.prevent="onSubmit">
        ...
        <div class="form-group">
          ...
          <span class="form-group-addon"><i class="glyphicon glyphicon-user"></i></span>
          <input v-model="User.surname" class="form-control" data-error="Введіть прізвище" id="surname" name="surname"
        ...
        <div class="form-group">
          ...
          <span class="form-group-addon"><i class="glyphicon glyphicon-user"></i></span>
          <input v-model="User.country" class="form-control" data-error="Введіть імʼя" id="country" name="country"
                 type="text"/>
          <div class="help-block with-errors"></div>
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
          ...
          <input v-model="User.email" type="email" class="form-control" id="email" name="email"
                 data-error="Введіть правильний email" placeholder="Email">
          <div class="help-block with-errors"></div>
        </div>
        <div class="form-group">
          <label for="login" class="control-label">Логін</label>
          <span class="form-group-addon"><i class="glyphicon glyphicon-home"></i></span>
          <input v-model="User.login" type="text" class="form-control" id="login" name="login"
                 data-error="Введіть правильний email" placeholder="Email" required>
          <div class="help-block with-errors"></div>
        </div>
        <div class="form-group">
    ...
    <div class="col-md-6">
      <form v-on:submit.prevent="changePassword">
        <div class="form-group">
          ...
          <input v-model="password" type="password" id="password1" name="password" data-minlength="5"
                 class="form-control" v-validate="'required'" data-error="Пароль має містити мінімум 5 символів"
        ...
        <div class="form-group">
          ...
          <input type="password" v-validate="'confirmed:password'"
                 :class="{'input': true, 'is-danger': errors.has('password') }" v-model="password2" id="password2"
                 name="password2" data-minlength="5" class="form-control" data-error="Паролі не співпадають"
                 placeholder="Пароль" required>
      ...
      <form v-on:submit.prevent="changeImg">
        <div class="form-group">
          ...
          <div class="col-md-4 inputGroupContainer">
            <div class="form-group">
              <input v-validate="'image|size:2000'" :class="{'input': true, 'is-danger': errors.has('password') }"
                     @change="uploadImage" type="file" name="image" required accept="image/*">
